...
const nicknames = ['mo_werewolf', 'fred_villager', 'joligeheidi', 'bimboooo', 'den_john', 'pelvis', 'bot'];
const passwords = ['mo_werewolf', 'fred_villager', 'asjemenou', 'bimboooo', 'den_john', 'elvispelvis', 'bot'];
...
function GameEngine(gameCoordinator, gameCoordinatorPw, moderator, moderatorPw, xmppSrv) {
    ...
    function startBot(nickname, password) {
        ...
        return new Bot(new BotXmppHelper(jid, password, xmppSrv, gameCoordinator, nickname));
    }
