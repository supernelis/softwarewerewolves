...
function MagicStrings(){
    ...
    this.loadMagicString('WEREWOLVES_WIN_ANNOUNCEMENT', 'Oh no! Werewolves are not outnumbered by villagers anymore, so the werewolves know they are stronger and they mount a daytime massacre and slaughter all remaining villagers!\n The werewolves win')
    // announce that villagers win
    this.loadMagicString('VILLAGERS_WIN_ANNOUNCEMENT', 'Yes! The last werewolve is dead! Finally peace in the village!\n The villagers win.')
