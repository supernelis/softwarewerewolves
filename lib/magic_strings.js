...
function MagicStrings(){
    ...
    this.loadMagicString('PLAY_REQUEST_STRING', 'I want to play as a ');
...
MagicStrings.prototype.getMagicString = function(key){
	if (this.magicStrings[key] == undefined) throw new Error('retrieving value for non-existing key ' + key);this
