...
function MagicStrings(){
    ...
    this.loadMagicString('WEREWOLVES_WIN_ANNOUNCEMENT', 'Oh no! As there is only one villager per werewolf left, the werewolves know they are stronger and they mount an attack during daylight and slaughter all remaining villagers!\n The werewolves win')
