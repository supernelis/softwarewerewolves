...
function Mc(jid, password, host, participants) {
    ...
    function startTheNight(){
        ...
        // ask the werewolf who he wants to eat
        msg = new xmpp.Message({to: room_jid + '/' + self.werewolves[0], type: 'chat'});
        msg.c('body').t(WHO_DO_YOU_WANT_TO_EAT);
        self.client.send(msg);
    }
