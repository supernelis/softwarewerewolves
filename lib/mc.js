...
function Mc(jid, password, host, participants) {
    ...
    user.Resource.call(this, jid, password, host, participants);
    ...
    self.client.on('online', function () {
        ...
        self.client.send(new xmpp.Element('message', {to: room_jid, type: 'groupchat'})
            .c('subject')
            .t('Night'));
            ...
            if (status){
                ...
                if (return_code == 201 || return_code == 110){
                   ...
                   setTimeout(function(){
                        ...
                        msg = new xmpp.Element('message', {to: room_jid, type: 'groupchat', id: 'cold_night'});
...
util.inherits(Mc, user.Resource);
