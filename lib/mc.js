...
function Mc(jid, password, host, players) {
    ...
    var participants = players.map(function(p){return new Player(p);});
    ...
    function receive_participant(participant, welcome) {
        var found = false;
    ...
    var arrival = function(participant){
        ...
        receive_participant(participant + '@' + self.srv, welcome);
    };
